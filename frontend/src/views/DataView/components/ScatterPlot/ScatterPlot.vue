...
import { useScatterConfig } from '../../composables/useScatterConfig.js'
...
function updateChart() {
  // console.log(props)
  if (!myChart) return
  const { optionPost: newOption } = useScatterConfig(
    props.memId,
    props.date,
    props.type
  )
...
<template>
  <div class="wh-full f-c">
    <e-charts id="Scatter-main" class="chart" :option="optionPost" />
  </div>
</template>
